...
server <- function(input, output, session) {
  ...
  #ha datum a tengely, akkor itt ne válassza ki mégegyszer, mert akkor egy uresre kicserelne a mar kivalasztott datum oszlopot, ezert van az ifelse elagazas
    ...
    )
    {
      ...
      abra_df[3] <-
        lapply(
          ...
          szazalek = input$label_format_percent
        ) #fent van összerakva!!!
